...
##xpsi, ypsi = cp.meshgrid(pd.X,pd.Y) #x and y matrices for pylab graphing for psi
##xfield, yfield = cp.meshgrid(pd.X[1:-1],pd.Y[1:-1]) #ditto for the vector field; we're cutting off the edges because this is a central different approximation
##
##plt.figure(1)
